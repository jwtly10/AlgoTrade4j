...
public class StrategyManager {
    ...
    public void startStrategy(StrategyConfig config, String strategyId) {
        ...
        RiskManager riskManager = new RiskManager(strategy.getRiskProfileConfig(), accountManager, eventPublisher, strategyId, from);

        TradeManager tradeManager = new DefaultTradeManager(currentTick, barSeries, strategy.getStrategyId(), eventPublisher, riskManager);
