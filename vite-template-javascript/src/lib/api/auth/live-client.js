...
export const liveClient = {
  ...
  createLiveStrategy: async (strategy) => {
    const url = `${V1}/live/strategies`;
    try {
  ...
  updateLiveStrategy: async (strategy) => {
  ...
  toggleLiveStrategy: async (strategyId) => {
  ...
  deleteLiveStrategy: async (strategyId) => {
    const url = `${V1}/live/strategies/${strategyId}`;
    try {
  ...
  closeLiveTrade: async (strategyId, tradeId) => {
